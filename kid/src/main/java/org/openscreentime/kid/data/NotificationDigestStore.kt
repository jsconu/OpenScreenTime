...
/**
 * Local, on-device store for the kid's optional notification digest (see #20).
 * Resets at local midnight like [UsageStore]. Nothing here is synced.
 */
class NotificationDigestStore(context: Context) {
    ...
    /** Off by default - this is a personal nicety, not part of core monitoring. */
    var optedIn: Boolean
