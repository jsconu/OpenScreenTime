...
This is software about children and their phones. Discussions about parenting choices,
screen-time philosophy and what a family "should" do will come up, and people will disagree
sincerely. Disagree about the software. Don't tell someone they're a bad parent, and don't
post anything about a real child — screenshots, usage data, ages, or names — in an issue or
pull request. Redact before you paste.
...
to the maintainer through
[GitHub's private reporting on this repository](https://github.com/jsconu/OpenScreenTime/security/advisories/new),
which opens a thread only the maintainer can see. All complaints will be reviewed and
